...
sendButtonVid: {
    ...
    */
    send3TemplateButtonImg: {
       ...
       * @param {Object} options 
       */
sendTemplateButtonVideoGif: {
async value (jid, contentText, footer, video, dtux, urlx, dtcx, nmbrx, buttons1, row1, buttons2, row2, buttons3, row3, quoted, options) {
        const message = {
            video: { url: video }, ...options,
            gifPlayback: true, jpegThumbnail: await (await fetch(media)).buffer(), fileLength: fsizedoc,
            caption: contentText,
            footer: footer,
            templateButtons: [
                {
