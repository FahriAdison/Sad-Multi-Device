/* If You Copy, Don`t Delete This Credit!!! 
  ...
  Regards from YanXiao And Papah ♡
*/
...
const sess = `${opts._[0] || 'papah'}.store.json`
...
global.reloadHandler = async function (restatConn) {
  ...
  conn.bye = '❖━━━━━━[ ʟᴇᴀᴠɪɴɢ ]━━━━━━❖\n𝚂𝚊𝚢𝚘𝚗𝚊𝚛𝚊 @user 👋😃'
  conn.spromote = '@user Sekarang jadi admin!Selamat Ya'
  conn.sdemote = '@user Sekarang bukan lagi admin!Wkwk Kasian'
