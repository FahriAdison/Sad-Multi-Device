...
global.authFile = `${opts._[0] || 'papah'}.json`
const { state, saveCreds } = await useMultiFileAuthState('./sessions')

const connectionOptions = {
  printQRInTerminal: true,
  auth: state,
  browser: ["Sad-Bot", "Safari", "5.0.0"],
...
async function connectionUpdate(update) {
  ...
  if (global.db.data == null) loadDatabase()
    if (update.receivedPendingNotifications) conn.sendMessage('19294427777@c.us', '「 *NOTIFICATION!* 」\n\n _Bot Berhasil Terhubung!_\n_Silahkan Gambung Di Group Ini Jika Mau Info Update Fitur Dll_\nhttp://chat.whatsapp.com/JFzipOMAz155jOldBdqUZy', 'conversation');
}
